...
HD_PWD='C:/Users/sisauto/Desktop/PracticasSEA/Tutorial5/Tutorial5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SemiSumador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SemiSumador.tcl
