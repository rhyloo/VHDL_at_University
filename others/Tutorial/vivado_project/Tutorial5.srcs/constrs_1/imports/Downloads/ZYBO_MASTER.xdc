...
##Pmod Header JC
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { b }]; #IO_L10P_T1_34 Sch=JC1_P. JC1 Connector Pin.
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { a }]; #IO_L10N_T1_34 Sch=JC1_N. JC2 Connector Pin.
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { s }]; #IO_L1P_T0_34 Sch=JC2_P. JC3 Connector Pin.
set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { c }]; #IO_L1N_T0_34 Sch=JC2_N. JC4 Connector Pin.
